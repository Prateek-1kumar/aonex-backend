// domain_profiles: per-domain extraction tuning (preferred parsers + rolling LLM
// hit-rate/avg-confidence/sample-count). Rebuilt nightly; read by the link adapter
// to pick parsers for a domain.
