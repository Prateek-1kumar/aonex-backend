// Shared text normalization for grounding + retrieval. Deliberately small and
// deterministic — the verifier and the RAG retriever must agree on what "the
// same token" means, or grounding checks and example selection drift apart.
