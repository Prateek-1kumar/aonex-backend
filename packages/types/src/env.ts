...
export const EnvSchema = z.object({
  ...
  // Catalog enrichment ("Push to Enrich") runs on Groq (GROQ_API_KEY above).
  // GROQ_MODEL_ENRICH selects the primary model; GROQ_MODEL_FALLBACK is used
  // automatically when the primary model's per-day token budget is exhausted.
