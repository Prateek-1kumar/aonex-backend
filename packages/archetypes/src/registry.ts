...
// Seeds (v1 verticals + generic fallback). The registry stays LEAN (commerce +
// descriptive) so ingestion's gap-fill + the admission gate read only their own
// fields; the universal content schema is unioned in by scoreCompletenessPercent.
